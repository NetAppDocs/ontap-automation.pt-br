...
Segurança:: Uma nova  `whoami` funcionalidade foi adicionada para recuperar o nome de usuário, a função e as informações de permissões do usuário conectado. A capacidade de autenticação web (WebAuthn) também foi aprimorada.
