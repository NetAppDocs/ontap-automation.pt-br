...
Você pode usar o NetApp.ONTAP PowerShell Toolkit para automatizar a administração de um cluster ONTAP a partir de um host Windows. Consulte link:../pstk/learn-about-pstk.html["Saiba mais sobre o NetApp ONTAP PowerShell Toolkit"] para obter mais informações.
