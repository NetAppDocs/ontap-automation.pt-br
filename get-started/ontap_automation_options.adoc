...
.Catálogo de automação do NetApp Console
O NetApp https://console.netapp.com/automationCatalog/["Catálogo de automação do NetApp Console"^] está disponível por meio da interface de usuário da web do Console.  O catálogo fornece acesso a soluções empacotadas que podem ajudar você a automatizar a implantação e a integração do ONTAP com outros produtos.  Ver https://docs.netapp.com/us-en/netapp-automation/["Automação da NetApp"^] para documentação e mais informações.
