...
summary: O ONTAP Counter Manager mantém informações abrangentes sobre o desempenho de cada sistema ONTAP. Ele exporta esses dados como contadores de performance que você pode usar para avaliar a performance do seu sistema ONTAP e ajudar a atingir suas metas de desempenho. 
---
...
Consulte a documentação de mapeamento apropriada com base na versão do ONTAP que você está usando:

* https://docs.netapp.com/us-en/ontap-pcmap/["Mapeamento do contador de desempenho ONTAP 9.15,1"^]
* https://docs.netapp.com/us-en/ontap-pcmap-9141/["Mapeamento do contador de desempenho ONTAP 9.14,1"^]
* https://docs.netapp.com/us-en/ontap-pcmap-9131/["Mapeamento do contador de desempenho ONTAP 9.13,1"^]
* https://docs.netapp.com/us-en/ontap-pcmap-9121/["Mapeamento do contador de desempenho ONTAP 9.12,1"^]
* https://docs.netapp.com/us-en/ontap-pcmap-9111/["Mapeamento do contador de desempenho ONTAP 9.11,1"^]
