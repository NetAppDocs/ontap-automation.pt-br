...
NOTE: Para versões do ONTAP anteriores à 9.9.1, você pode automatizar a administração das permissões SACL e DACL usando o recurso de passagem direta da CLI. Consulte link:../migrate/migration-considerations.html["Migre da ONTAPI para a API REST"] para mais informações.
